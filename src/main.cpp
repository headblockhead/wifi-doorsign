...
void loop() {
  ...
  client.print("<input type=\"color\" id=\"input_color\" name=\"input_color\" "
               "value=\"#ffffff\" style=\"flex-grow:1;margin-left:10px;\" />");
  client.print("</div>");
  client.print("<hr style=\"width:600px; margin-left:0px;\"/>");
  ...
  client.print(
      "document.getElementById('input_color').addEventListener('input', "
      "function() {");
  client.print("updateImage(document.getElementById('img'));");
  client.print("});");
  ...
  client.print("ctx.fillStyle = document.getElementById('input_color').value;");
